...
PROFILE = {
    ...
    "biomechanical_findings": [
        ...
        },
        {
            ...
            "test": {
                ...
                "last_result": (
                    ...
                    "⚠ SCOPE OF THAT REFUTATION, added 2026-08-20 after it was "
                    "misread once: it rules the iliopsoas out of THE SIT-BONE SNAP "
                    "ONLY. It says nothing about the front of the hip, where finding "
                    "#4 names the same tendon, tested POSITIVE on 2026-08-17, and "
                    "carries three evidence entries. Do not read this line against "
                    "anterior hip work - the two findings are different locations "
                    "with different triggers, and only this one is refuted. "
        ...
        },
        {
            ...
            "additional_evidence_2026_08_18": (
                ...
                "concluded from the other direction that every positive observation "
                "involves active hip flexion under iliopsoas contraction. Two "
                "independent routes to one structure. "
                "STATUS OF THE DRILL: its own regression is 'nothing tender to find, or "
    ...
    # ─────────────────────────────────────────────────────────────────────────
    #  MOVED OUT 2026-09-18 — this file is his POSITION, not his programme.
    #  The athlete, on being asked whether the pre-session release protocol and
    #  the retired stage exit criteria belonged here: "Both come out they're
    #  not my profile. Move it to somewhere more relevant like previous
    #  training history." Both now live in training_history.py, verbatim.
    #  What a block actually runs is authored in training_plan.py, which is
    #  where it always was — the copy here was a second statement of it.
    # ─────────────────────────────────────────────────────────────────────────
    ...
    "stage_transitions": [
        ...
        },
        {
            ...
            "event": "BLOCK B AUTHORED as training_plan.PLAN_BLOCK_B, Phase 4 at clinical "
                     ...
                     "90/90 and Lateral Lunge OUT (finding #5 quiet — re-measured on day 24, "
                     "revert on any crack); the two hip isometrics off the cluster day and "
                     "onto the short Tuesday runs, so the cluster day is release + the "
                     "five-item stack + lift-offs, 10 entries and ~45 min against 13 and 61; "
                     "the ischial release re-coded "
