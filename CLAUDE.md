...
Expected: **1521/1521 passed** (or higher — this count grows as tests are added; treat it as a floor, not an exact match)
...
1. `python -m pytest tests/` → 1521/1521 (or higher if new tests were added)
...
tests/       — pytest suite (1521 tests), the sole deterministic gate
