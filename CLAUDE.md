...
Expected: **1224/1224 passed** (or higher — this count grows as tests are added; treat it as a floor, not an exact match)
...
1. `python -m pytest tests/` → 1224/1224 (or higher if new tests were added)
...
tests/       — pytest suite (1224 tests), the sole deterministic gate
