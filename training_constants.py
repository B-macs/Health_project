...
EXERCISE_REGION_SHARES: dict[str, dict[str, float]] = {
    ...
    '90/90 hip rotations with lift-offs':          {"upper_body": 0.00, "core": 0.10, "lower_body": 0.90},
    'Triangle side split, external-rotation cue':  {"upper_body": 0.00, "core": 0.10, "lower_body": 0.90},
